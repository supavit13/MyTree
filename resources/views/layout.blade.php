		...
		var arr=[];
            $("#add_table_risk").click(function(event){
              ...
              var data_risk1 = '<tr id="table1st" class="trRow" data-id="'+n+'">'+
                            '<td><input class="hideme" type="text" name="treePartSeq['+n+']"></td>'+'<td><input class="hideme" type="text" name="treePartName['+n+']"></td>'+'<td><input  type="text" class="form-control" name="treePartFactor['+n+']"></td>'+'<td><center><select class="ui dropdown" name="treePartDamage['+n+']"><option type="hidden">เลือก</option><option value="1">น้อย</option><option value="2">ปานกลาง</option><option value="3">มาก</option><option value="4">มากที่สุด</option></select></center></td>'+'<td><center><select class="ui dropdown" name="treePartDamage['+n+']"><option type="hidden">เลือก</option><option value="1">ต่ำมาก</option><option value="2">ต่ำ</option><option value="3">ปานกลาง</option><option value="4">สูง</option></select></center></td>'+'<td><center><select class="ui dropdown" name="treePartDamage['+n+']"><option type="hidden">เลือก</option><option value="1">น้อย</option><option value="2">ค่อนข้างน้อย</option><option value="3">มาก</option><option value="4">มากที่สุด</option></select></center></td>'+'<td><center><select class="ui dropdown" name="treePartDamage['+n+']"><option type="hidden">เลือก</option><option value="1">ต่ำ</option><option value="2">ปานกลาง</option><option value="3">รุนแรง</option><option value="4">รุนแรงมาก</option></select></center></td>'+'<td><input type="button" class="ui red button delete_tr1" id="delete_tr1" data-id="'+n+'" value="ลบ"></td>'+'</tr>';
