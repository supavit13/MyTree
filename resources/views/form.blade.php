                ...
                <div class="ui grid">
                 ...
                 <div class="eight wide column">
                  ...
                  <div class="three wide column">
                    ...
                    <input id="Tree_lat" type="number" min="0" value="<?php if(!empty($lat)){ echo $lat; }else { getData($tree,'text','Tree_lat'); } ?>" class="form-control anti-Minus" name="Tree_lat" required>
                  </div>

                  <div class="three wide column">
                    <span>พิกัดลองจิจูด</span>
                    <input id="Tree_long" type="number" min="0" value="<?php if(!empty($lng)){ echo $lng; }else { getData($tree,'text','Tree_long'); } ?>" class="form-control anti-Minus" name="Tree_long">
                  </div>
