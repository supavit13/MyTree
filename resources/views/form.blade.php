                ...
                <div class="ui grid">
                 ...
                 <div class="eight wide column">
                  ...
                  <div class="three wide column">
                    ...
                    <input id="Tree_lat" type="number" step="0.000001" value="<?php if(!empty($lat)){ echo $lat; }else { getData($tree,'text','Tree_lat'); } ?>" class="form-control anti-Minus" name="Tree_lat" >
                  </div>

                  <div class="three wide column">
                    <span>พิกัดลองจิจูด</span>
                    <input id="Tree_long" type="number" step="0.000001" value="<?php if(!empty($lng)){ echo $lng; }else { getData($tree,'text','Tree_long'); } ?>" class="form-control anti-Minus" name="Tree_long" >
                  </div>
                  ...
                  <div class="five wide column">
                    <span>ชนิด</span>
                    <input id="TreeName" type="text" value="<?php getData($tree,'text','Tree_name'); ?>" class="form-control" name="Tree_name" >
                  </div>
                  ...
                  <div class="five wide column">
                    ...
                    <input id="Tree_diameter_Trunk" type="number" step="0.01" value="<?php getData($tree,'text','Tree_diameter_Trunk'); ?>" class="form-control anti-Minus" name="Tree_diameter_Trunk" >
                  ...
                  <div class="five wide column">
                    ...
                    <input type="text" value="<?php echo $userlogin['username'] ?>" class="form-control" name="User_name" >
                 ...
                 <div class="five wide column">
                    <span>โทรศัพท์</span>
                    <input  type="number"  class="form-control input-md" value="<?php getData($tree,'text','Tree_phone'); ?>" name="Tree_phone">
                  </div>
