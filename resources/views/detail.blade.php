...
<div class='container' style='width: 60%' align='center'>
    <label style="font-size: 19px;">สำรวจโดย : </label><span><a href='/profiles/{{$users['_id']}}'>{{$users['username']}}</a></span>
</div>
<hr>
...
<div class="A4">
  ...
  <span style="font-weight: bold;">เจ้าของพื้นที่</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 5cm;" value="<?php getData($tree,'text','ownerarea'); ?>">
    </span>
  
  <span style="font-weight: bold;">ที่อยู่</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 7cm;" value="<?php getData($tree,'text','Tree_address'); ?>">
    </span>
  
  <span style="font-weight: bold;">วันที่</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 3cm;" value="<?php getData($tree,'text','Tree_date'); ?>">
    </span>

  <span style="font-weight: bold;">&nbspเวลา</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 3cm;" value="<?php getData($tree,'text','Tree_time'); ?>">
    </span>
  <span>น.</span>
  ...
  <span style="font-weight: bold;">ต้นที่</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 2cm;" value="<?php getData($tree,'text','Tree_sequence'); ?>">
    </span>
  
  <span style="font-weight: bold;">พิกัด</span>
  <span style="font-weight: bold;">X:</span>  
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 2.5cm;" value="<?php getData($tree,'text','Tree_lat'); ?>">
    </span>
  
  <span style="font-weight: bold;">Y:</span>  
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 2.5cm;" value="<?php getData($tree,'text','Tree_long'); ?>">
    </span>

  <span style="font-weight: bold;">ชนิด</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 3.5cm;" value="<?php getData($tree,'text','Tree_name'); ?>">
    </span>

  <span style="font-weight: bold;">ชื่อวิทยาศาสตร์</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 7cm;" value="<?php getData($tree,'text','Tree_sci_name'); ?>">
    </span>
  ...
  <span style="font-weight: bold;">เส้นผ่านศูนย์กลางเพียงอก</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','Tree_diameter_Trunk'); ?>">
    </span>
  <span style="font-weight: bold;">เซนติเมตร</span>

  <span id="tab" style="font-weight: bold;">ความสูงทั้งหมด</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','Tree_height'); ?>">
    </span>
  <span style="font-weight: bold;">เมตร</span>

  <span id="tab" style="font-weight: bold;">เส้นผ่านศูนย์กลางเรือนยอด</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','Tree_diameter_Top'); ?>">
    </span>
  <span style="font-weight: bold;">เมตร</span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด -->
  ...
  <span style="font-weight: bold;">ผู้ประเมิน</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 6.5cm;" value="<?php echo $userlogin['username'] ?>">
    </span>

  <span style="font-weight: bold;">หน่วยงาน</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 10cm;" value="<?php getData($tree,'text','agency'); ?>">
    </span>

  <span style="font-weight: bold;">&nbspโทรศัพท์</span>
    <span>
      <input readonly type="text" class="hideme"  id="input1" style="width: 3.5cm;" value="<?php getData($tree,'text','Tree_phone'); ?> ">
    </span>
          ...
          <tr>
            ...
            <td>
              <div style="text-align: center;">
                <input disabled type="checkbox" class="ui checkbox" name="ch1[<?php echo $i; ?>]" <?php if($tree['ch1'][$i]=="on"){ echo "checked=''";}?>>
              </div>
            </td>
            <td>
              <div style="text-align: center;">
                <input disabled type="checkbox" class="ui checkbox" name="ch2[<?php echo $i; ?>]" <?php if($tree['ch2'][$i]=="on"){ echo "checked=''";}?>>
              </div>
            </td>
            <td>
              <div style="text-align: center;">
                <input disabled type="checkbox" class="ui checkbox" name="ch3[<?php echo $i; ?>]" <?php if($tree['ch3'][$i]=="on"){ echo "checked=''";}?>>
              </div>
            </td>                          
...
<br><br>
  ...
  <span style="font-weight: bold;">ประวัติการล้มเหลวของต้นไม้ในอดีต</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 20cm;" value="<?php getData($tree,'text','damageInArea'); ?>">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span id="tab" style="font-weight: bold;">ทิศด้านลาด</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 4.75cm;" value="<?php getData($tree,'text','slopeDirection'); ?>">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>รายละเอียด</span> 
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 13cm;" value="<?php getData($tree,'text','changeAreaDetail'); ?>">
    </span>               
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh2" <?php getData($tree,'checkbox','soilCh2');?>>
  </span>
  <span>เนื้อดินจำกัด</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh3" <?php getData($tree,'checkbox','soilCh3');?>>
  </span>
  <span>น้ำแช่ขัง</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh5" <?php getData($tree,'checkbox','soilCh5');?>>
  </span>
  <span>ดินตื้น</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh4" <?php getData($tree,'checkbox','soilCh4');?>>
  </span>
  <span>ดินแน่นแข็ง</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh6" <?php getData($tree,'checkbox','soilCh6');?>>
  </span>
  <span>มีวัสดุปิดทับ</span> 

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="soilCh7" <?php getData($tree,'checkbox','soilCh7');?>>
  </span>
  <span>อื่นๆ รายละเอียดเพิ่มเติม</span> 
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 9.5cm;" value="<?php getData($tree,'text','soilDetail'); ?>">
    </span> 
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span style="font-weight: bold;" >สภาพอากาศ</span> 
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="weather1" <?php getData($tree,'checkbox','weather1');?>>
    </span>
    <span  >ลมแรง</span>
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="weather2" <?php getData($tree,'checkbox','weather2');?>>
    </span>
    <span>ฝนตกหนัก</span>
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="weather3" <?php getData($tree,'checkbox','weather3');?>>
    </span>
    <span>อื่นๆ รายละเอียดเพิ่มเติม</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 28%;" value="<?php getData($tree,'text','weather_other'); ?>">
    </span> 
...
<br><br>
  ...
  <span id="tab" style="font-weight: bold;">สภาพใบ</span>
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh1" <?php getData($tree,'checkbox','leafCh1');?>>
    </span>
    <span>ปกติ</span>
  
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh2" <?php getData($tree,'checkbox','leafCh2');?>>
    </span>
    <span>ผลัดใบ</span>
  
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh3" <?php getData($tree,'checkbox','leafCh3');?>>
    </span>
    <span>ผิดปกติ</span>
  
    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh4" <?php getData($tree,'checkbox','leafCh4');?>>
    </span>
    <span>ร่วง</span>
    <span>
      <input readonly type="text"  class="hideme" id="input1" style="width: 4%;" value="<?php getData($tree,'text','leafCh4_text'); ?>">
    </span>
    <span>%</span>

    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh5" <?php getData($tree,'checkbox','leafCh5');?>>
    </span>
    <span>ซีดเหลือง</span>
    <span>
      <input readonly type="text"  class="hideme" id="input1" style="width: 4%;" value="<?php getData($tree,'text','leafCh5_text'); ?>">
    </span>
    <span>%</span>

    <span>
      <input disabled type="checkbox" class="ui checkbox" name="leafCh5_5" <?php getData($tree,'checkbox','leafCh5_5');?>>
    </span>
    <span>แห้ง</span>
    <span>
      <input readonly type="text"  class="hideme" id="input1" style="width: 4%;" value="<?php getData($tree,'text','leafCh6_text'); ?>">
    </span>
    <span>%</span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span style="font-weight: bold;">ตัวการที่มีชีวิต</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 7cm;" value="<?php getData($tree,'text','monster1'); ?>">
    </span>
  <span>อาการ</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 14cm;" value="<?php getData($tree,'text','symptom1'); ?>">
    </span>

<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  <span style="font-weight: bold;">ตัวการที่ไม่มีชีวิต</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 7cm;" value="<?php getData($tree,'text','monster2'); ?>">
    </span>
  <span>อาการ</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 14cm;" value="<?php getData($tree,'text','symptom2'); ?>">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span id="tab" style="font-weight: bold;">Live-Crown ration</span>
    <span>
      <input readonly type="text" class="hideme" name="liveCrownPercen" id="input1" style="width: 3cm;" value="<?php getData($tree,'text','liveCrownPercen'); ?>">
    </span>
  <span style="font-weight: bold;">%</span>
  <span>
    <input disabled type="checkbox" class="ui checkbox">
  </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="dryBranches" <?php getData($tree,'checkbox','dryBranches');?>>
  </span>
  <span>กิ่งแห้ง</span>
   <span>
      <input readonly type="text" name="limbDie" class="hideme" id="input1" style="width: 1cm;" value="<?php getData($tree,'text','limbDie'); ?>">
    </span>
  <span>%</span>

  <span>ขนาดใหญ่สุด</span>
   <span>
      <input readonly type="text" class="hideme" name="limbDieSize" id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','limbDieSize'); ?>">
    </span>
  <span>ซม.</span>


  <span id="tab">
    <input disabled type="checkbox" class="ui checkbox" name="brokenBranches" <?php getData($tree,'checkbox','brokenBranches');?>>
  </span>
  <span>กิ่งหักแขวน</span>

  <span id="tab">จำนวน</span>
   <span>
      <input readonly type="text" class="hideme" name="limbBroke" id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','limbBroke'); ?>">
    </span>
  <span>กิ่ง</span>

  <span id="tab">ขนาดใหญ่สุด</span>
   <span>
      <input readonly type="text" class="hideme" name="limbBrokeSize" id="input1" style="width: 1.5cm;" value="<?php getData($tree,'text','limbBrokeSize'); ?>">
    </span>
  <span>ซม.</span>
  ...
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="limbLesion" <?php getData($tree,'checkbox','limbLesion');?>>
  </span>
  <span>รอยแผลกิ่ง</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="limbHole" <?php getData($tree,'checkbox','limbHole');?>>
  </span>
  <span>รอยผุโพรงหรือรู</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="limbNode" <?php getData($tree,'checkbox','limbNode');?>>
  </span>
  <span>ปุ่มปม</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="limbRotten" <?php getData($tree,'checkbox','limbRotten');?>>
  </span>
  <span>เน่า</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="limbFungus" <?php getData($tree,'checkbox','limbFungus');?>>
  </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>&nbspรายละเอียด</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 10cm;" value="<?php getData($tree,'text','limbLitOther'); ?>" >
    </span> 
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span style="font-weight: bold;">สิ่งที่ต้องเฝ้าระวัง</span>
    <span>
      <input readonly type="text" class="hideme" name="topStayAlert" id="input1" style="width: 15cm;" value="<?php getData($tree,'text','topStayAlert'); ?>">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkTwin');?>>
  </span>
  <span>&nbspแตก2นาง</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkTogather');?>>
  </span>
  <span>&nbspมีเปลือกร่วม</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkDie');?>> 
  </span>
  <span>&nbspเปลือกแห้ง/หลุดร่อน</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkAbnormal');?>>
  </span>
  <span>&nbspเปลือกผิดปกติ</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkBroke');?>>
  </span>
  <span>&nbspมีรอยแตก</span>
  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkHole');?>>
  </span>
  <span>&nbspโพรง</span>
  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkDecay');?>>
  </span>
  <span>&nbspผุ</span>
  ...
  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkLiquid');?>>
  </span>
  <span>&nbspมีน้ำยางหรือของเหลวไหลออกจากเปลือก</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkNode');?>>
  </span>
  <span>มีปุ่มปมหรือตา</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkDecayDamage');?>>
  </span>
  <span>&nbspเนื้อไม้ผุเสียหาย</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkFungus');?>>
  </span>
  <span>&nbspมีเชื้อราเห็ด</span>


  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkThin');?>>
  </span>
  <span>&nbspความเรียวผิดปกติ</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" <?php getData($tree,'checkbox','trunkSlope_checkbox');?>>
  </span>
  <span>&nbspเอียง</span>
    <span>
      <input readonly type="text" class="hideme" name="trunkSlope" id="input1" style="width: 2cm;" value="<?php getData($tree,'text','trunkSlope'); ?>">
    </span>
  <span>องศา</span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span style="font-weight: bold;">สิ่งที่ต้องเฝ้าระวัง</span>
    <span>
      <input readonly type="text" class="hideme" name="trunkStayAlert" id="input1" style="width: 15cm;" value="<?php getData($tree,'text','trunkStayAlert'); ?>">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootDown" <?php getData($tree,'checkbox','rootDown');?> >
    <span>โคนต้นฝังดิน</span>
  </span> 
  
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootWrap" <?php getData($tree,'checkbox','rootWrap');?> >
    <span>รากพันโคนต้น</span>
  </span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootUp" <?php getData($tree,'checkbox','rootUp');?>></span>
    <span>โผล่พ้นดิน</span>
  </span>
  
  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootBroke" <?php getData($tree,'checkbox','rootBroke');?>>
  </span>
  <span>แตกหักหรือถูกตัด</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootLesion" <?php getData($tree,'checkbox','rootLesion');?>>
  </span>
  <span>เสียดสี</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootLiquid" <?php getData($tree,'checkbox','rootLiquid');?>>
  </span>
  <span>มีของเหลวไหลจากเปลือก</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootNode" <?php getData($tree,'checkbox','rootNode');?>>
  </span>
  <span>มีปุ่มปมหรือตา</span>

  <span>
    <input disabled type="checkbox" class="ui checkbox" name="rootDecay" <?php getData($tree,'checkbox','rootDecay');?>>
  </span>
  <span>ผุ</span>
 
 <!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
<span>
  <input disabled type="checkbox" class="ui checkbox" name="rootCavity" <?php getData($tree,'checkbox','rootCavity');?>>
  <span>โพรง</span>
<span>
  <input disabled type="checkbox" class="ui checkbox" name="rootFungus" <?php getData($tree,'checkbox','rootFungus');?> >
  <span>เชื้อรา เห็ด</span>
<span>
  <input disabled type="checkbox" class="ui checkbox" name="rootWater" <?php getData($tree,'checkbox','rootWater');?> >
  <span>น้ำแช่ขัง</span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span style="font-weight: bold;">สิ่งที่ต้องเฝ้าระวัง</span>
    <span>
      <input readonly type="text" class="hideme" name="rootStayAlert" id="input1" style="width: 15cm;" value="<?php getData($tree,'text','rootStayAlert'); ?>">
    </span>
                ...
                @if($tree!=NULL and $tree['treePartName']!=NULL)
                  ...
                  <tr>  <!-- ราก -->
                   ...
                   <td>
                    ...
                    <input readonly class="hideme" id="input1" type="text" name="treeDamage[<?php echo $n; ?>]" value="<?php echo $tree['treeDamage'][$n]; ?>" >
                    </td>
                  </tr> <!-- end ราก -->
                  <?php $i++; ?>
                  @endforeach
...
<!-- - - - - - - - - - - - - matrix2 - - - - - - - - - - - - - - -->
  ...
  <span style="font-weight: bold;">คำอธิบายเพิ่มเติม</span>
    <span>
      <input readonly type="text" class="hideme" name="moreDetail" id="input1" style="width: 25cm;" value="<?php getData($tree,'text','moreDetail'); ?>">
    </span>
    
    <!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  <span style="font-weight: bold;">วิธีแก้ไข</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 10cm;" value=" <?php getData($tree,'text','Solution1'); ?> ">
    </span>
  <span style="font-weight: bold;">ปัญหาที่เหลือ</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 11cm;" value=" <?php getData($tree,'text','problem1'); ?> ">
    </span>

        <!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  <span style="font-weight: bold;">วิธีแก้ไข</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 10cm;" value=" <?php getData($tree,'text','Solution2'); ?> ">
    </span>
  <span style="font-weight: bold;">ปัญหาที่เหลือ</span>
    <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 11cm;" value=" <?php getData($tree,'text','problem2'); ?> ">
    </span>
...
<!-- เว้นบรรทัด --> <div style="margin-top: 1%;"></div> <!-- เว้นบรรทัด --> 
  ...
  <span>เรื่อง</span>
    <span>
      <input readonly type="text" class="hideme" name="needMore" id="input1" style="width: 20%;" value="<?php getData($tree,'text','needMore'); ?>">
    </span>

  <span style="font-weight: bold;">ระยะเวลาที่ควรมีการตรวจสอบ(ทุกๆ)</span>
  <span>
      <input readonly type="text" class="hideme" id="input1" style="width: 15%;" value="<?php getData($tree,'text','validTime'); ?>">
    </span>
@stop