            ...
            <div class="panel-body">
                <form class="ui form">
                  ...
                  <div class="field" id="policy">
                    <textarea>
                      ขอขอบคุณที่ใช้ผลิตภัณฑ์และบริการของเรา บริการนี้จัดทำโดย นิสิตคณะวิศวกรรมศาสตร์ ศรีราชา สาขาวิศวกรรมคอมพิวเตอร์ มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตศรีราชา ซึ่งตั้งอยู่ที่ 199 ถ.สุขุมวิท ต.ทุ่งสุขลา อ.ศรีราชา จ.ชลบุรี 20230 การใช้บริการของเราถือเป็นการยอมรับข้อกำหนดนี้ โปรดอ่านอย่างละเอียด
                      -การใช้บริการของเรา
                      คุณต้องปฏิบัติตามนโยบายใด ๆ ที่มีต่อคุณภายในบริการนี้
                        ห้ามใช้บริการของเราในทางมิชอบ คุณต้องใช้บริการของเราเฉพาะตามที่กฎหมายอนุญาตและกฎระเบียบบังคับใช้ เราอาจระงับหรือหยุดการให้บริการแก่คุณหากคุณไม่ปฏิบัติตามข้อกำหนดและนโยบายของเรา หรือหากเราตรวจสอบพบพฤติกรรมที่น่าสงสัยว่าไม่ถูกต้อง
                      การใช้บริการของเราไม่ได้ทำให้คุณเป็นเจ้าของสิทธิในทรัพย์สินทางปัญญาใด ๆ ในบริการหรือเนื้อหาที่คุณเข้าถึง คุณไม่สามารถใช้เนื้อหาในบริการของเรา เว้นแต่ได้รับการอนุญาตจากเจ้าของเนื้อหาดังกล่าว 
                       ...
                       เราอาจตรวจสอบเนื้อหาเพื่อพิจารณาว่าเนื้อหานั้นผิดกฎหมายหรือละเมิดนโยบายของเราหรือไม่ เราอาจปฏิเสธที่จะแสดงเนื้อหาที่เราเชื่อว่ามีเหตุผลสมควร
                      ผิดกฎหมายและละเมิดนโยบายของเรา
                      ...
                      -เนื้อหาของคุณในบริการของเรา
                        บริการบางอย่างของเราอนุญาตให้คุณอัพโหลด  ส่งเนื้อหามาให้ คุณยังคงความเป็นเจ้าของสิทธิ์ในทรัพย์สินทางปัญญาใด ๆ ที่คุณถือสิทธิ์ในเนื้อหานั้น ๆ
                         เมื่อคุณอัพโหลด ส่งเนื้อหามาให้ จัดเก็บ ส่งหรือรับเนื้อหามายังหรือผ่านบริการของเรา ถือว่าคุณได้อนุญาตให้ My tree มีสิทธิ์ในเนื้อหาของคุณ ไม่ว่าที่ใดในโลก ในการทำซ้ำ ดัดแปลง แก้ไข สร้างงานต่อยอดเนื้อหาของคุณ หรือการเปลี่ยนแปลงอื่น ๆ

                      -เกี่ยวกับซอฟต์แวร์ในบริการของเรา
                        My tree อนุญาตให้ใช้สิทธิในซอฟต์แวร์ที่ My tree จัดหาให้คุณในฐานะส่วนหนึ่งของบริการ การอนุญาตให้ใช้สิทธินี้มีวัตถุประสงค์
                      คือ ให้คุณสามารถใช้งานและใช้ประโยชน์จากบริการที่จัดหาโดย My tree ตามข้อกำหนด ห้ามคุณคัดลอก ปรับเปลี่ยน แจกจ่าย จำหน่าย หรือให้เช่าส่วนหนึ่งส่วนใดของบริการของเราหรือซอฟต์แวร์ที่อยู่ใน และห้ามคุณดำเนินกระบวนการวิศวกรรมย้อนกลับหรือพยายามแยกซอร์สโค้ดของซอฟต์แวร์นั้น 

                      -การปรับเปลี่ยนและการยุติการให้บริการของเรา
                        เราทำการเปลี่ยนแปลงและปรับปรุงบริการอย่างสม่ำเสมอ เราอาจเพิ่มหรือนำระบบการทำงานหรือคุณสมบัติบางอย่างออก หรือระงับใช้บริการ
                      ใดบริการหนึ่งอย่างสิ้นเชิง
                        คุณสามารถหยุดใช้บริการของเราได้ทุกเมื่อ หรือทางMy treeอาจหยุให้บริการแก่คุณหรือเพิ่มสร้างขีดจำกัดใหม่ๆ ในบริการของเราได้ทุกเมื่อโดยไม่แจ้งให้คุณทราบ
                      ...
                      หากคุณไม่ปฏิบัติตามข้อกำหนดนี้ และเราไม่ได้ดำเนินการใดโดยทันที จะไม่ถือว่าเราสละสิทธิใด ๆ ที่มี
                    </textarea>
                  </div>
